        ...
        <div className="">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <button className="flex items-center gap-2 px-4 py-2 whitespace-nowrap rounded-md bg-zinc-700 shadow-[0px_0px_10px_rgba(38,71,95,0.25)] hover:bg-zinc-600 max-md:px-3">
                <img
                  loading="lazy"
