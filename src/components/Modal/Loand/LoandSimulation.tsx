...
//     const payments = 12 // Example: 12 payments for a year
...
//         <thead>
//           <tr>
//             <th className="py-3 px-4 text-left text-xs font-normal text-neutral-400 border-b border-neutral-800">
//               Cuota
//             </th>
//             <th className="py-3 px-4 text-left text-xs font-normal text-neutral-400 border-b border-neutral-800">
//               Fecha
//             </th>
//             <th className="py-3 px-4 text-right text-xs font-normal text-neutral-400 border-b border-neutral-800">
//               Pago
//             </th>
//             <th className="py-3 px-4 text-right text-xs font-normal text-neutral-400 border-b border-neutral-800">
//               Capital
...
//               Saldo
//             </th>
//             <th className="py-3 px-4 text-center text-xs font-normal text-neutral-400 border-b border-neutral-800">
//               Estado
//             </th>
//           </tr>
//         </thead>
//         <tbody>
//           {simulationData.map((payment, index) => (
//             <tr key={payment.paymentNumber} className={index % 2 === 0 ? "bg-neutral-800/20" : ""}>
//               <td className="py-3 px-4 text-sm">{payment.paymentNumber}</td>
//               <td className="py-3 px-4 text-sm">{new Date(payment.paymentDate).toLocaleDateString("es-ES")}</td>
//               <td className="py-3 px-4 text-sm text-right">C${payment.paymentAmount}</td>
//               <td className="py-3 px-4 text-sm text-right">C${payment.principalPayment}</td>
//               <td className="py-3 px-4 text-sm text-right">C${payment.interestPayment}</td>
//               <td className="py-3 px-4 text-sm text-right">C${payment.remainingBalance}</td>
//               <td className="py-3 px-4 text-center">
//                 {payment.status === "pendiente" ? (
//                   <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-green-native/10 text-green-native">
//                     Pendiente
//                   </span>
//                 ) : (
...
//               <span>Cuotas</span>
//             </div>
//             <p className="text-lg font-medium text-white">{simulationData.length}</p>
//           </div>
